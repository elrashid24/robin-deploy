...
import FantasyChirpItem from "./fantasy_chirp_item";
...
class FantasyChirps extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      nflChirps: []
      ...
      <div className="xx">
        <div className="item-container">
          {this.state.nflChirps.map((trend, index) => (
            <FantasyChirpItem key={index} trend={trend} />
          ))}
        </div>
